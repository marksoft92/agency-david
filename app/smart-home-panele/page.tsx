...
export default function HomePage() {
    return (
        <main className="bg-black text-white min-h-screen py-[5rem]">
            <Seo title="Panel Sonoff i Smart Home na miarę Twoich potrzeb" description="Profesjonalne automatyzacje dla Twojego domu, sterowanie domem, automatyka domu"
                keywords="panel, sonoff, smart home, automatyzacje, sterowanie domem, automatyka domu, automatyka, sterowanie, dom, garaż, brama, światła, automatyka domu, automatyka garażu, automatyka bramy, sterowanie telefonem"
                url="https://bienkowski.dev/smart-home-panele"
                city="Drawno"
                entry={{
                    description: "Profesjonalne automatyzacje dla Twojego domu, sterowanie domem, automatyka domu",
                    seo: {
                        street: "ul. słoneczna 10",
                        postalCode: "73-220"
                    }
                }}
                slug="smart-home-panele"
            />
