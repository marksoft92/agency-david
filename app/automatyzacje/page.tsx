...
export default function HomePage() {
    return (
        <main className="bg-black text-white min-h-screen py-[5rem]">
            <Seo title="Automatyzacje, sterowanie domem, automatyka domu" description="Profesjonalne automatyzacje dla Twojego domu, sterowanie domem, automatyka domu"
                keywords="automatyzacje,supla, sterowanie domem, automatyka domu, automatyka, sterowanie, dom, garaż, brama, światła, automatyka domu, automatyka garażu, automatyka bramy, sterowanie telefonem"
                url="https://bienkowski.dev/automatyzacje"
                city="Drawno"
                entry={{
