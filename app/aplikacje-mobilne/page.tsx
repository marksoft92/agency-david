...
export default function HomePage() {
    return (
        <main className="bg-black text-white min-h-screen py-[5rem]">
            <Seo title="Aplikacje mobilne" description="Profesjonalne aplikacje mobilne dla Twojego biznesu"
                keywords="aplikacje, mobilne, biznes, aplikacje mobilne, aplikacje mobilne dla biznesu, aplikacje mobilne dla firmy, "
                url="https://bienkowski.dev/aplikacje-mobilne"
                city="Drawno"
                entry={{
                    description: "Profesjonalne aplikacje mobilne dla Twojego biznesu",
                    seo: {
